"""Reads output from the CARMA test carma_sigmafalltest.F90.

NOTE: This script uses a version of the CARMA standalone model that has
some additional IO functions in ncio_mod.F90 which allow the output of dz.
...
# Open netcdf file
nc_file = netCDF4.Dataset('carma_sigmafalltest.nc', 'r')
...
plt.tight_layout()
plt.savefig('read_sigmafalltest.png')
plt.show()
